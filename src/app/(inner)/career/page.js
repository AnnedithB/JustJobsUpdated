                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="career-banner-wrapper">
                                    ...
                                    <a href="/job-listing" className="rts-btn btn-primary btn-bold">
                                        Current Openings
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 pl--50 pl_md--15 pl_sm--10 mt_md--30 pt_sm--30">
                                <div className="career-right-two-wrapper aligncentercareer">
                                    ...
                                    <p>
                                    Your ideas matter. We foster a culture where creative thinking and fresh perspectives are encouraged, giving you the freedom to contribute, collaborate, and see your ideas shape real solutions.Your ideas matter. We foster a culture where creative thinking and fresh perspectives are encouraged, giving you the freedom to contribute, collaborate, and see your ideas shape real solutions.
                                    </p>
                                    {/* 
